...
import ProductRightimg from "../../../public/images/products/hero-bg.svg";
  ...
  return (
    <section>
      ...
      <div className="relative overflow-hidden py-16 lg:py-0">
        ...
        <div className="relative z-10 mx-auto grid max-w-[90%] lg:max-w-[80%] items-center gap-12 px-6 py-12 lg:grid-cols-2 lg:py-10">
          {/* Left */}
